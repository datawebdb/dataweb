echo "starting apac_data_relay!"
echo $PWD

export RELAY_NAME="apac_data_relay"
export DATABASE_URL='postgres://postgres:dev!@localhost/apac_data_relay'
export RESULT_SOURCE_OBJECT_STORE="LocalFileSystem"
export RESULT_SOURCE_PFX="${PWD}/results/"
export FLIGHT_SERVICE_ENDPOINT="0.0.0.0:50053"
export MSG_BROKER_OPTS='{"type": "AsyncChannel"}'
export REST_SERVICE_URL="0.0.0.0"
export REST_SERVICE_PORT="8445"
export CA_CERT_FILE=${PWD}/cacert.pem
export SERVER_CERT_FILE=${PWD}/deploy/development/apac_data_relay/cert.pem 
export SERVER_KEY_FILE=${PWD}/deploy/development/apac_data_relay/key.pem
export CLIENT_CERT_FILE=${PWD}/deploy/development/apac_data_relay/client_cert.pem 
export CLIENT_KEY_FILE=${PWD}/deploy/development/apac_data_relay/client_key.pem
